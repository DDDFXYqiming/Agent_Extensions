...
## 中文长概览：skill / bilibili-uploader-discovery.md

本文件属于公开技能 `skill` 下的 `bilibili-uploader-discovery.md` 文档，目标是把幻灯片、模板、图表、配图、动画或脚本相关的全部规格统一收纳，便于复用与扩展。
...
## 中文主体说明：Hermes_Agent_Resources 参考资料：bilibili uploader discovery
...
- 本节说明 `Durable 工作流` 相关的任务目标、输入、输出、关键约束和验收标准。
