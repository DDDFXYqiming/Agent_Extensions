...
本文件的相对路径是 `ppt-master/templates/layouts/government_blue/design_spec.md`，属于 `AI_Projects` 的参考/工作流/模板/脚本/资产之一。
...
- Deep blue gradient background + tech grid texture（以上为中文意译，具体细节以英文原文为准）。
- Left-side bright blue accent bar（以上为中文意译，具体细节以英文原文为准）。
- Main title + subtitle (white)（以上为中文意译，具体细节以英文原文为准）。
- Presenter/Organization info（以上为中文意译，具体细节以英文原文为准）。
...
- 本节对应原始英文段落。中文部分负责解释目标、流程、风险与验收，不替代下方英文细则。
- Light blue gradient background（以上为中文意译，具体细节以英文原文为准）。
- Left-side decorative trapezoid + gradient vertical bar（以上为中文意译，具体细节以英文原文为准）。
- Supports up to 5 chapters（以上为中文意译，具体细节以英文原文为准）。
- Circular numbering + connector line design（以上为中文意译，具体细节以英文原文为准）。
...
- Radial glow decoration（以上为中文意译，具体细节以英文原文为准）。
- Large chapter number (semi-transparent + stroke effect)（以上为中文意译，具体细节以英文原文为准）。
...
- Gradient number block（以上为中文意译，具体细节以英文原文为准）。
- Dashed divider lines（以上为中文意译，具体细节以英文原文为准）。
...
- 本节对应原始英文段落。中文部分负责解释目标、流程、风险与验收，不替代下方英文细则。
- Deep blue gradient background（以上为中文意译，具体细节以英文原文为准）。
- Wave curve decoration（以上为中文意译，具体细节以英文原文为准）。
- Centered thank-you message (Chinese and English)（以上为中文意译，具体细节以英文原文为准）。
- Bright blue divider line（以上为中文意译，具体细节以英文原文为准）。
