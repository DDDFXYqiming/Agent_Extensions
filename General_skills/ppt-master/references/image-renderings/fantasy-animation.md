...
## 中文长概览：skill / fantasy-animation.md

本文件属于公开技能 `skill` 下的 `fantasy-animation.md` 文档，目标是把幻灯片、模板、图表、配图、动画或脚本相关的全部规格统一收纳，便于复用与扩展。
...
## 中文主体说明：Hermes_Agent_Resources 参考资料：fantasy animation
