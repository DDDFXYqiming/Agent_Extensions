...
## 中文长概览：skill / project.md

本文件属于公开技能 `skill` 下的 `project.md` 文档，目标是把幻灯片、模板、图表、配图、动画或脚本相关的全部规格统一收纳，便于复用与扩展。
...
## 中文主体说明：Hermes_Agent_Resources 文档：project
...
> Architecture rationale (why `import-sources` defaults are asymmetric for in-repo vs out-of-repo files): see design documentation (not bundled with this repo).

Project tools create, validate, and inspect the standard PPT Master workspace.

## `project_manager.py`

### 中文：project_manager py

- 本节对应原始英文段落。中文部分负责解释目标、流程、风险与验收，不替代下方英文细则。
- Main entry point for project setup and validation（以上为中文意译，具体细节以英文原文为准）。
```bash
...
- 本节对应原始英文段落。中文部分负责解释目标、流程、风险与验收，不替代下方英文细则。
- Shared helper module used by other scripts（以上为中文意译，具体细节以英文原文为准）。
- Typical use（以上为中文意译，具体细节以英文原文为准）。
```python
...
### 中文：batch_validate py

- 本节对应原始英文段落。中文部分负责解释目标、流程、风险与验收，不替代下方英文细则。
- Batch-check project structure and compliance（以上为中文意译，具体细节以英文原文为准）。
```bash
...
### 中文：generate_examples_index py

- 本节对应原始英文段落。中文部分负责解释目标、流程、风险与验收，不替代下方英文细则。
- Rebuild `examples/README（以上为中文意译，具体细节以英文原文为准）。
- md` automatically（以上为中文意译，具体细节以英文原文为准）。
```bash
...
### 中文：pptx_template_import py

- 本节对应原始英文段落。中文部分负责解释目标、流程、风险与验收，不替代下方英文细则。
- Unified PPTX preparation entry point for `/create-template`（以上为中文意译，具体细节以英文原文为准）。
```bash
...
- 本节对应原始英文段落。中文部分负责解释目标、流程、风险与验收，不替代下方英文细则。
- Show standardized fixes for common project errors（以上为中文意译，具体细节以英文原文为准）。
```bash
